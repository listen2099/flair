...
def sam_to_psl(samfile, outfilename, chromsizefile, quick=False):
	...
	with open(outfilename, 'wt') as outfile, open(samfile, 'r') as sam:
...
if __name__ == "__main__":
	try:
		...
		sys.exit(1)
	sam_to_psl(sam, outfilename, chromsizefile, quick)
